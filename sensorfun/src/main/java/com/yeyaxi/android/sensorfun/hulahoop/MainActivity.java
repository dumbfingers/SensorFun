...
import com.yeyaxi.android.sensorfun.hulahoop.util.TabsPagerAdapter;
...
//            AlarmScheduler.scheduleAlarm(this, 5);
            sendBroadcast(new Intent(ACTION_RECORD_ALL));
        }
	}
...
//        AlarmScheduler.cancelAlarm(this);
    ...
    public void onDialogFragmentInteraction(boolean startRecord) {
        if (startRecord == true) {
            ...
            Toast.makeText(MainActivity.this, "Press HOME button to start background recording", Toast.LENGTH_LONG).show();
        }
    }

    private boolean checkSensorServiceAlive() {
        ActivityManager manager = (ActivityManager) getSystemService(ACTIVITY_SERVICE);
        return isRecordServiceRunning(manager);
    }
