...
//                AlarmScheduler.cancelAlarm(com.yeyaxi.android.sensorfun.com.yeyaxi.android.sensorfun.SensorService.this);
                // cancel notification
...
//                mSensorManager.unregisterListener(com.yeyaxi.android.sensorfun.com.yeyaxi.android.sensorfun.SensorService.this);
                showNotification();
            }
...
//		}
		...
		File f = new File(Environment.getExternalStorageDirectory(), "/HulaHoop/");
		if (f.exists() == false) {
			if (f.mkdirs() == true) {
				return f;
			} else {
